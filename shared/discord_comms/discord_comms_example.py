...
# Import the DiscordComms class and DiscordCommsSettings at the top of the file
...
# Apply nest_asyncio to enable asyncio to run in a notebook or similar environments
nest_asyncio.apply()
